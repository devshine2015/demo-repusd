...
function Searchwidget() {
    ...
    async function searchToken(searchName) {
        ...
        /*let res = await fetch("http://" + window.location.hostname + ":5000/search", {
            method: 'POST',
            headers: {
        ...
        <div className="row">
            <div className="col-12" ref={wrapperRef}>
                <div className={(tokenResult.length > 0) ? "input-group search_auto mb-2" : "input-group search_auto mb-2"}>
                    ...
                    <input className="form-control border-secondary py-2" type="search" placeholder="Search by Token" value={tokenInfo} onChange={(e) => searchToken(e.target.value)} onKeyUp={(e) => keyHandler(e)}/>
                    <div className="input-group-append">
                        <button className="btn btn-outline-secondary plus_icon" type="button">
