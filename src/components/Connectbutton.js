...
function Connectbutton() {
    ...
    async function connectMetamask() {
        ...
        window.ethereum.on('accountsChanged', (accounts) => {
            if (accounts[0]) {
                reactLocalStorage.set('walletConnect', 'connected')
    ...
    useEffect(() => {   
        ...
        let connected = reactLocalStorage.get('walletConnect');
    ...
    return (
        <div>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
                ...
                <Modal.Body>
                    <Button variant="info" onClick={connectMetamask} block>
                    ...
                    <Button variant="info" onClick={connectWalletConnect} block>
